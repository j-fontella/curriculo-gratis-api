package gratis.curriculo.models.endereco;
...
public class Endereco {
    ...
    public String getEnderecoCompletoParaImpressao() {
        String complemento = Utils.isNullOrBlank(this.complemento) ? "" : " (" + this.complemento + ")";
